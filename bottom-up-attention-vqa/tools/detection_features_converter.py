...
infile = '/home/ubuntu/bottom-up-attention/res.tsv.0'
...
if __name__ == '__main__':
    ...
    val_img_bb = h_val.create_dataset(
        'image_bb', (2, num_fixed_boxes, 4), 'f')
    val_img_features = h_val.create_dataset(
        'image_features', (2, num_fixed_boxes, feature_length), 'f')
    val_spatial_img_features = h_val.create_dataset(
        'spatial_features', (2, num_fixed_boxes, 6), 'f')
